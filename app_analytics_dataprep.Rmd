...
#### Sorting data frame ---------------------------
## We will first arrange the columns and sort them by memberNumber and transactionTime.
...
appDataPivot <-
    ...
    reshape2::dcast(memberNumber + sessionId + transactionDt + transactionHr + transactionMin +
          longitude + latitude
          ~ screenName)
...
write.table(appDataPivot, paste0(exportPath, "/appDataPivot.csv"), sep = ",", 
            row.names = F)
```
